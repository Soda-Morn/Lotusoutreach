        ...
        <div class="container mx-auto px-6 lg:px-8">
          <div class="max-w-3xl">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
              <button class="px-8 py-4 bg-pink-600 hover:bg-pink-700 text-white font-semibold rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg">
                Support Cambodia
              </button>
              <button class="px-8 py-4 border-2 border-white text-white hover:bg-white hover:text-gray-900 font-semibold rounded-full transition-all duration-300">
    ...
    <section ref="statisticsRef" class="py-20 bg-gradient-to-r from-blue-50 to-pink-50">
      <div class="container mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div class="group">
            <div :class="['text-5xl font-bold mb-2 group-hover:scale-110 transition-transform duration-300', counters.children.color]">
          ...
          <div class="group">
            <div :class="['text-5xl font-bold mb-2 group-hover:scale-110 transition-transform duration-300', counters.villagers.color]">
          ...
          <div class="group">
            <div :class="['text-5xl font-bold mb-2 group-hover:scale-110 transition-transform duration-300', counters.years.color]">
    ...
    <section class="relative py-20 overflow-hidden">
      ...
      <div class="relative z-10 container mx-auto px-6 text-center">
        <div class="max-w-4xl mx-auto">
          ...
          <button class="px-10 py-4 bg-white text-pink-600 font-bold rounded-full hover:bg-gray-100 transition-colors duration-300 transform hover:scale-105 shadow-lg">
